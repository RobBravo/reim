"""Honduras — monthly merchandise trade from the IMF's IMTS dataflow."""
...
class ImfImtsHonduras(ImfImtsTradeConnector):
    """IMF IMTS merchandise trade for Honduras.
    ...
    connector_key = "imf_imts_honduras"
