"""Panama — monthly merchandise trade from the IMF's IMTS dataflow."""
...
class ImfImtsPanama(ImfImtsTradeConnector):
    """IMF IMTS merchandise trade for Panama.
